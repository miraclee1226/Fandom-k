...
// function createTwoDimensionalArray(arr, subArrayLength) {
//   const twoDimensionalArray = [];

//   for (let i = 0; i < arr.length; i += subArrayLength) {
//     twoDimensionalArray.push(arr.slice(i, i + subArrayLength));
//   }
...
//   const [nextEndFlag, setNextEndFlag] = useState(false);
...
//   const { requestFunc: getIdolsData } = useRequest({ skip: true });

//   const handleLeftBtnClick = async () => {
//     if (currentPage === 1) return;
//     setNextEndFlag(false);
//     setCurrentPage((prevPage) => prevPage - 1);
//   };

//   const handleRightBtnClick = async () => {
//     console.log(currentPage, idolsDataArr.length);
//     if (currentPage > idolsDataArr.length) return;
//     setCurrentPage((prevPage) => prevPage + 1);
//   };
...
//   useEffect(() => {
//     (async () => {
//       const totalDataCount = currentPage * pageSize;
//       const flattedDataArr = idolsDataArr.flat();
//       const currentDataCount = flattedDataArr.length;
...
//           url: "/idols",
//           params: {
//             pageSize: totalDataCount - currentDataCount,
//             cursor: flattedDataArr[currentDataCount - 1]?.id || 0,
//           },
//         });

//         if (!result?.data?.nextCursor) setLastPage();
//         const updatedFlatArr = [...flattedDataArr, ...result?.data?.list];

//         setIdolsDataArr(createTwoDimensionalArray(updatedFlatArr, pageSize));
//       } else {
//         setIdolsDataArr(createTwoDimensionalArray(flattedDataArr, pageSize));
//       }
//     })();
...
//                   {idolsDataArr[currentPage - 1]?.map((idol) => (
